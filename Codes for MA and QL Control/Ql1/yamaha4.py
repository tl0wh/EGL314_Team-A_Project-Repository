...
if __name__ == "__main__":
    ...
    command = 'set MIXER:Current/InCh/Fader/Level 1 0 20'
    run_command(command)
    command = 'set MIXER:Current/InCh/Fader/Level 2 0 -238'
    run_command(command)
    command = 'set MIXER:Current/InCh/Fader/Level 0 0 -879'
    run_command(command)
    command = 'set MIXER:Current/InCh/Fader/Level 4 0 1000'
    run_command(command)
    command = 'set MIXER:Current/InCh/Fader/Level 3 0 500'
    run_command(command)
