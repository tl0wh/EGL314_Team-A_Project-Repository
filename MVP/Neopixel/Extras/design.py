...
# Function to create a dynamic light show
def dynamic_light_show(receiver_ip, receiver_port, num_pixels, duration_sec):
    ...
    while time.time() < end_time:
        ...
        # Example pattern: Color sweep
        hue = current_time / duration_sec  # Sweep through hues over time
...
# Example light show
dynamic_light_show(PI_A_ADDR, PORT, NUM_PIXELS, DURATION_SEC)
